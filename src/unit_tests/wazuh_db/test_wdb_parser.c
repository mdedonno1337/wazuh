...
void test_dbsync_insert_type_exists_null_stmt(void **state) {
    ...
    expect_string(__wrap__mdebug1, formatted_msg, "Cannot get cache statement");
...
void test_dbsync_delete_type_exists_data_bind_error(void **state) {
    ...
    will_return(__wrap_wdb_get_cache_stmt, 1);
    will_return_always(__wrap_sqlite3_errmsg, "trc");

    expect_value(__wrap_sqlite3_bind_text, pos, 1);
    expect_string(__wrap_sqlite3_bind_text, buffer, "data5");
    will_return(__wrap_sqlite3_bind_text, SQLITE_ERROR);

    expect_string(__wrap__merror, formatted_msg, "DB(000) sqlite3_bind_text(): trc");
    will_return(__wrap_wdb_step, SQLITE_DONE);
...
void test_dbsync_modify_type_exists_data_bind_error(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "DB(000) sqlite3_bind_text(): trc");
    expect_string(__wrap__merror, formatted_msg, "DB(000) sqlite3_bind_text(): trc");
    expect_string(__wrap__merror, formatted_msg, "DB(000) sqlite3_bind_int(): trc");
    expect_string(__wrap__merror, formatted_msg, "DB(000) sqlite3_bind_text(): trc");
...
void test_dbsync_modify_type_exists_data_bind_error_ports(void **state) {
    ...
    will_return(__wrap_sqlite3_column_text, "data5");
    expect_value(__wrap_sqlite3_column_int, iCol, 5);
    will_return(__wrap_sqlite3_column_int, 6);
    expect_value(__wrap_sqlite3_column_int, iCol, 6);
    will_return(__wrap_sqlite3_column_int, 7);
    ...
    will_return(__wrap_sqlite3_column_int, 9);
    expect_value(__wrap_sqlite3_column_text, iCol, 9);
    will_return(__wrap_sqlite3_column_text, "data10");
    expect_value(__wrap_sqlite3_column_int, iCol, 10);
    will_return(__wrap_sqlite3_column_int, 11);
    expect_value(__wrap_sqlite3_column_text, iCol, 11);
    will_return(__wrap_sqlite3_column_text, "data12");
    expect_value(__wrap_sqlite3_column_text, iCol, 12);
    will_return(__wrap_sqlite3_column_text, "data13");
    expect_value(__wrap_sqlite3_column_text, iCol, 13);
    will_return(__wrap_sqlite3_column_text, "data14");

    ret = wdb_parse_dbsync(data->wdb, query, data->output);

    assert_string_equal(data->output, "ok data1|data2|data3|4|data5|6|7|8|9|data10|11|data12|data13|data14|");
    assert_int_equal(ret, OS_SUCCESS);
...
void test_dbsync_delete_type_exists_data_compound_pk_select_data_fail(void **state) {
    ...
    will_return_always(__wrap_sqlite3_errmsg, "trc");
    expect_string(__wrap__merror, formatted_msg, "DB(000) sqlite3_step(): trc");
