...
void test_syscollector_dbsync_os_valid_msg_no_result_payload(void **state)
{
    ...
    expect_string(__wrap__merror, formatted_msg, "Response without content, the event cannot be raised.");
    int ret = DecodeSyscollector(lf, &sock);
...
void test_syscollector_dbsync_valid_msg_no_operation_or_data_no_object(void **state)
{
    ...
    expect_string(__wrap__merror, formatted_msg, "Incorrect/unknown operation, type: hotfixes.");
    expect_string(__wrap__mdebug1, formatted_msg, "Unable to send dbsync information to Wazuh DB.");
...
void test_syscollector_dbsync_valid_msg_null_agentid(void **state)
{
    ...
    expect_string(__wrap__mdebug1, formatted_msg, "Unable to send dbsync_processes information to Wazuh DB.");
